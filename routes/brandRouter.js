...
router.route('/')
    ...
    .post(brandMiddleware.validateCreateBrand, brandController.applySlugify, brandController.createBrand)

router.route('/:id')
    .get(brandMiddleware.validateGetBrandParams, brandController.getBrand)
    .put(brandMiddleware.validateUpdateBrand, brandController.applySlugify, brandController.updateBrand)
